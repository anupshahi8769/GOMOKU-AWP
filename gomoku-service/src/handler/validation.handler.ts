...
// import { LoginInput, SignupInput, signupSchema} from "../schema/validation.schema"
// import { signJwt } from "../utils/jwt";

// const validationHandler = express.Router();

// validationHandler.post("/signup", validateSchema(signupSchema) , async (req: Request<{}, {}, SignupInput["body"]>, res: Response) => {
//     try{
